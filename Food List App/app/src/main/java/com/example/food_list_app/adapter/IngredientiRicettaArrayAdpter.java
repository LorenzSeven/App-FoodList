...
public class IngredientiRicettaArrayAdpter extends ArrayAdapter<Ingrediente> {
    Context context = null;

    public IngredientiRicettaArrayAdpter(Context context, int resource, ArrayList<Ingrediente> ingredienti) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View contentView = li.inflate(R.layout.lista_item_ingrediente_ricetta_checkbox, parent, false);
        ...
        checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(checkBox.isChecked()) ingr.setIsChecked(true);
                else if(!checkBox.isChecked()) ingr.setIsChecked(false);
            }
        });
